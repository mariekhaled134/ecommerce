...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'allorders',
        loadComponent: () => import('./feature/allorders/allorders.component').then(m => m.AllordersComponent),
        title: 'orders',
      },
      {
        path: 'cart',
      ...
      },
      {
        ...
        loadComponent: () => import('./feature/details/details.component').then(m => m.DetailsComponent),
        title: 'details',
      },
      {
        path: 'brand',
        loadComponent: () => import('./feature/brand/brand.component').then(m => m.BrandComponent),
        title: 'brand',
      },
      {
        path: 'product',
      ...
      {
        path: 'Categries',
        loadComponent: () => import('./feature/categries/categries.component').then(m => m.CategriesComponent),
        title: 'Categries',
      },
{
  path: 'reset-password',
  loadComponent: () =>
 import('./core/auth/reset-password/reset-password/reset-password.component')
